...
│ ├── Contactmap_Ab42t-Mem
│ ├── Contactmap_Ab42t-gD
│ └── Contactmap_Ab42t-gD-Mem
│
├── FEL_inhouse_script/
│ ├── FEL_Ab42t-gD
│ ├── FEL_Ab42t-gD-Mem
│ └── FEL_Ab42t-Mem
│
├── Initial_coordination_files_for_MD/
│ ├── Ab42d-gD-Mem.pdb
│ ├── Ab42h-gD-Mem.pdb
│ ├── Ab42t-gD.pdb
│ ├── Ab42t-gD-Mem.pdb
│ ├── Ab42t-Mem.pdb
│ ├── gD-Mem.pdb
│ ├── neuronal_membrane.pdb
│ └── AB_Hexamer/
│ ├── ab_hexamer_experimental_structure.pdb
│ ├── cluster_1.pdb
│ ├── cluster_2.pdb
│ ├── cluster_3.pdb
│ ├── cluster_4.pdb
...
│ └── cluster_10.pdb
│
└── tcl_script(VMD)_for_Saltbridge/
├── saltbridge_PC_PE_PS_SPM-Positivechargeres_gD-MEM.tcl
